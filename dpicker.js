/*
gjl.datepicker implementation of https://chmln.github.io/flatpickr/examples/
*/
...
(function(gjl) {
    ...
    var start = function(elID, config) {
        var el = document.getElementById(elID);
        if (el === null) {
            console.error('gjl.datepicker error on config. ID on element return no valid DOM element: ' + elID);
            return false;
        }
        config = config || {};

        if (1 === 1) { //TODO : implement proper lang testing (gj.lang!)
            config.dateFormat = config.dateFormat ? config.dateFormat : 'd.m.Y'; //setting NO format on date
            config.locale = extend(NorwegianSettings(), config.locale); //overwrite default locale values with config from user
        } else {
    ...
    // default is english settings
    var NorwegianSettings = function() {
        CustomLocale = {
            weekdays: {
...
.flatpickr-day.endRange.nextMonthDay {
    /*J9 background: #569ff7;*/
    background: #007272;
    border-color: #007272;
    -webkit-box-shadow: none;
    box-shadow: none;
    color: #fff;
    /*J9 border-color: #569ff7;*/
}
